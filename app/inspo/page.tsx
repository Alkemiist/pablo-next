                ...
                <div className="flex items-center gap-4">
                    ...
                    <Select value={filterValue} onValueChange={setFilterValue}>
                        ...
                        <SelectContent className="bg-neutral-950 border border-neutral-700">
                            ...
                            <SelectItem value="image" className="cursor-pointer hover:bg-neutral-800">Images</SelectItem>
                            <SelectItem value="video" className="cursor-pointer hover:bg-neutral-800">Videos</SelectItem>
                            <SelectItem value="article" className="cursor-pointer hover:bg-neutral-800">Articles</SelectItem>
                            <SelectItem value="design" className="cursor-pointer hover:bg-neutral-800">Designs</SelectItem>
                        </SelectContent>
                    </Select>
                    ...
                    <Select value={sortValue} onValueChange={setSortValue}>
                        ...
                        <SelectContent className="bg-neutral-950 border border-neutral-700">
                            ...
                            <SelectItem value="popular" className="cursor-pointer hover:bg-neutral-800">Most Popular</SelectItem>
