    ...
    return (
        ...
        <div className="flex items-center px-12 py-3 pt-8"> 
            ...
            <div className="flex-1 flex gap-8 text-left relative items-center">
                ...
                {/* the search input */}
                <input type="search" placeholder="Search" className="hidden lg:flex bg-slate-900 w-full lg:w-1/2 border pl-12 border-slate-700 text-white px-4 py-2 rounded-md focus:outline-none focus:ring focus:ring-white transition-colors duration-300" />
                ...
                <div className="relative">
                    ...
                    {
                        filterOpen && (
                            <div className="absolute flex flex-col border mt-8 md:w-60 bg-slate-900 border-slate-700 text-white rounded-md">
