...
export function AnalysisChart() {
  ...
  return (
    <Card className="pt-0 border border-gray-800 h-full flex flex-col">
      ...
      <CardHeader className="flex items-center gap-2 space-y-0 border-b border-gray-800 py-5 sm:flex-row">
        ...
        <div className="grid flex-1 gap-1">
          {/* <CardTitle>Overall Sentiment Relative to Engagement</CardTitle>
          <CardDescription>
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            className="hidden w-[160px] rounded-lg sm:ml-auto sm:flex border border-gray-800"
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6 flex-1">
        ...
        >
          <AreaChart data={filteredData} className="">
            <defs>
            ...
            <CartesianGrid vertical={false} strokeDasharray="3 3" stroke="var(--color-gray-600)" />
            ...
            {/* Chart lines for mobile and desktop */}
            <Area
              dataKey="mobile"
              type="natural"
              fill="url(#fillMobile)"
